...
//
// Renders BOTH variants — /logo.png (production) and /logo-dark-1.png (the
// white logo used by the premium dark preview). A pair of CSS rules in
// globals.css picks which one is visible: by default `.logo-dark` is
